...
-- NOTE: Set to true if you have a Nerd Font installed
...
vim.opt.undodir = 'C:/Users/jodden/AppData/local/nvim/undodir'
    ...
    config = function()
      ...
      require('telescope').setup {
        ...
        defaults = {
          ...
          --   },
          file_ignore_patterns = { 'node_modules', 'dist', 'src\\images', 'App_Code', 'Bin' },
        },
        -- pickers = {}
        extensions = {
          ['ui-select'] = {
